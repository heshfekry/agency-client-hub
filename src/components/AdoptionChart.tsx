...
const AdoptionChart = () => (
  <div className="mb-5 rounded-[10px] border border-border bg-card p-6">
    <div className="mb-5 font-display text-base font-normal text-foreground">How agencies describe their current AI integration</div>
    <div className="h-[165px]">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data}>
          ...
          <Tooltip formatter={(value: number) => [`${Math.round((value / 15) * 100)}%`]} contentStyle={{ fontFamily: 'Inter', fontSize: 12 }} />
